    ...
    public partial class GoodsList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["uName"] != null)
                ltCurUser.Text = "当前用户：" + Session["uName"]+"hhhhhhhhh" +Session["scID"];
            if (!IsPostBack) { DataListBind(); }
        }
        /// <summary>
        /// DataList分页数据绑定
        /// </summary>
        ...
        protected void dlstGoods_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (Session["uID"] != null && e.CommandName == "addShop")
            {
                ...
                string str = ConfigurationManager.ConnectionStrings["SMDBConnectionString1"].ConnectionString;
