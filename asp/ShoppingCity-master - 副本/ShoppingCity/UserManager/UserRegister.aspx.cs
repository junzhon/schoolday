...
namespace ShoppingCity
{
    ...
    public partial class Register : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            user.uName = txtuName.Text.Trim();   //并为相应的字段赋值
            user.uPwd = txtuPwd.Text.Trim();
            user.uRealName = txtuRealName.Text.Trim();
            user.uSex = rbluSex.SelectedValue.Trim();
            user.uAge = txtuAge.Text.Trim();
            ...
            user.uEmail = txtuEmail.Text.Trim();
            user.uQQ = txtuQQ.Text.Trim();
            user.uPhone = txtuPhone.Text.Trim();
            user.uImage = imguImage.ImageUrl.Substring(imguImage.ImageUrl.LastIndexOf("/") + 1);
            user.uRegTime = System.DateTime.Now.ToString();
